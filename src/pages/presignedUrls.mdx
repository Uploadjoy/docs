...
## Multi-part upload an object {{ tag: 'POST', label: '/v1/presigned-url/multipart-upload-objects' }}

<Row>
  <Col>

    This endpoint allows you to get presigned URLs to upload objects using multi-part upload. Read about S3 multi-part upload [here](https://docs.aws.amazon.com/AmazonS3/latest/dev/mpuoverview.html).
